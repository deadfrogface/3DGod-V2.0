# Stages 12–19 — honest gates (updated after TripoSR + LLamaSharp + SkinTokens license clear)
...
| 18/19 | FlaUI | Test-only UIA3 + SkippableFact | **IMPLEMENTED_GATED_EXTERNAL_RUNNER** (`3DGodCreator.UiTests`); InstalledAppSmoke baseline |
